...
app.on('ready', function() {
  ...
  express()
    .use(function (req, res, next) {
      ...
      if (process.env.MANDATORY_HEADER && process.env.MANDATORY_HEADER_VALUE ) {
        if (req.get(process.env.MANDATORY_HEADER.toLowerCase()) == process.env.MANDATORY_HEADER_VALUE) {
